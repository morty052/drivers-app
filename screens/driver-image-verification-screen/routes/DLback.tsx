...
const DLback = ({ navigation }: any) => {
  ...
  const { setDlBack } = useOnboardingStore();
      ...
      {image && (
        ...
        >
          ...
          <Text
            ...
            fontFamily={MEDIUM}
          >
            Is the back of your driver's license readable?
          </Text>
        </View>
      )}
      {image && (
